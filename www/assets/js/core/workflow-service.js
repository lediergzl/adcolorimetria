...
export async function saveDiagnosis(clientId, diagnosis) { return DB.put('diagnoses', { clientId, ...diagnosis }); }
export async function saveTarget(clientId, target) { return DB.put('colorTargets', { clientId, ...target }); }
...
export async function savePrediction(clientId, prediction) { return DB.put('predictions', { clientId, ...prediction }); }
export async function saveResult(clientId, result) { return DB.put('results', { clientId, ...result }); }
